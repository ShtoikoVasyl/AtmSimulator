...
public class Main {
  public static void main(String[] args) {
    int[] load = {2500, 0, 0, 1, 0}; // enter several banknotes to download (fifty, hundred, two hundred, five hundred, thousand)
    ATMloading loading = new ATMloading(); // first load
    System.out.println("Load is " + loading.ATMload(load));
    int[] load2 = {2500, 0, 0, 0, 0}; // enter several banknotes to download (fifty, hundred, two hundred, five hundred, thousand)
