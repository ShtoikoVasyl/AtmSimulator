...
public class WithdrawProvider implements WithdrawCalculator{
    ...
    public Map<String, Integer> calculate(Map<Integer, String> currencyMap, Map<String, Integer> availableBanknotesMap, int requestValue) throws WithdrawException {
        ...
        for (Integer iterator : currencyKey) {
            int value = calc(getQuantityFromAvailableMap(availableBanknotesMap, currencyMap, iterator), iterator, requestSum);
    ...
    private int getQuantityFromAvailableMap(Map<String, Integer> availableBanknotesMap, Map<Integer, String> currencyMap, Integer denomination){
        int result;
        try { result = availableBanknotesMap.get(currencyMap.get(denomination));
