...
public class InputPanel extends JPanel {
    ...
    public InputPanel(int horizontal, String text) {
        ...
        inputButton.setBounds(width / 7 * 3, 0, width / 7 * 4 - ServicePersonTerminal.indentations, ServicePersonTerminal.indentations * 2);
        ...
        inputField.setBounds(ServicePersonTerminal.indentations, 0, width / 7 * 3 - ServicePersonTerminal.indentations * 2, ServicePersonTerminal.indentations * 2);
