...
public class AvailablePanel extends JPanel {
    public final static int width = MainTerminalPanel.width / 5 * 2;
    ...
    public AvailablePanel() {
        setLayout(null);
        setBounds(ServicePersonTerminal.indentations, ServicePersonTerminal.indentations * 4,
                width - (ServicePersonTerminal.indentations * 3) / 2, height);
        fifty = new AvailableBanknotesLabel(height / 7 - ServicePersonTerminal.indentations, "Fifty:", "fifty");
        add(fifty);
        hundred = new AvailableBanknotesLabel(height / 7 * 2 - ServicePersonTerminal.indentations, "Hundred:", "hundred");
        add(hundred);
        twoHundred = new AvailableBanknotesLabel(height / 7 * 3 - ServicePersonTerminal.indentations, "Two hundred:", "twoHundred");
        add(twoHundred);
        fiveHundred = new AvailableBanknotesLabel(height / 7 * 4 - ServicePersonTerminal.indentations, "Five hundred:", "fiveHundred");
        add(fiveHundred);
        thousand = new AvailableBanknotesLabel(height / 7 * 5 - ServicePersonTerminal.indentations, "Thousand:", "thousand");
        add(thousand);
        totalBanknotes = new AvailableBanknotesLabel(height / 7 * 6, "Total quantity:", "totalQuantity");
        ...
        totalBanknotes.getRight().setBounds(width / 3 * 2 - ServicePersonTerminal.indentations * 2, 0,
        ...
        totalBanknotes.getLeft().setBounds(ServicePersonTerminal.indentations, 0,
