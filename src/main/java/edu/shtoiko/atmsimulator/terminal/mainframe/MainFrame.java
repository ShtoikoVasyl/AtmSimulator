...
public class MainFrame {
  ...
  public static final int height = gd.getDisplayMode().getWidth() / 2;

  /** Set fonts sze */
  public static final int fontSize = height * 13 / 720;
    ...
    EventQueue.invokeLater(
        new Runnable() {
          ...
          public void run() {
            ...
            /**
             * a button which, depending on the conditions, creates an object UserFrame or
             * ServicePersonalFrame
             */
            JButton autorized = new JButton();
            autorized.setText("Autorization");
            autorized.addActionListener(
                new ActionListener() {
                  @Override
